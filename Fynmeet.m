...
xlabel('Normalised Amplitude');
ylabel('Probability');
legend('Data','Rayleigh MLE','Rayleigh MoM');
...
xlabel('Normalised Amplitude');
ylabel('Probability');
legend('Data','Lognormal MLE','Lognormal MoM');
...
xlabel('Normalised Amplitude');
ylabel('Probability');
legend('Data','Weibull MLE','Weibull MoM');
...
xlabel('Normalised Amplitude');
ylabel('Probability');
legend('Data','K-Distribution Watts','K-Distribution MoM','K-Distribution Raghavan');
